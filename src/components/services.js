                                ...
                                <div className="page-center">
                                    ...
                                    <div className="service-tab-row">
                                        <div className="service-tab">
                                            ...
                                            <a href="/services.html" className="learn-more" target="_blank" aria-label="Scrum Transition, opens in new tab">Learn More</a>
                                        </div>
                                        <div className="service-tab">
                                            ...
                                            <a href="/services.html" className="learn-more" target="_blank" aria-label="Career Coaching, opens in new tab">Learn More</a>
                                        </div>
                                        <div className="service-tab">
                                            ...
                                            <a href="/services.html" className="learn-more" target="_blank" aria-label="Job Support, opens in new tab">Learn More</a>
                                        </div>
                                        <div className="service-tab">
                                        ...
                                        <div className="service-tab">
                                            ...
                                            <a href="/services.html" className="learn-more" target="_blank" aria-label="Agile Transformation, opens in new tab">Learn More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
